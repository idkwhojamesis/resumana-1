...
import sty from "./PlasmicButton.module.css"; // plasmic-import: ibY8vYTLSJ-/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: mHNRsb6EtxP/icon
import Icon3Icon from "./icons/PlasmicIcon__Icon3"; // plasmic-import: 7bIeOh58pA6/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__cp0DH)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon3Icon
                className={classNames(projectcss.all, sty.svg__aJZv)}
                role={"img"}
              />
            ),
